...
public class SloganPersistenceImpl extends BasePersistenceImpl<Slogan>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_COMPANYID = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_ENTITY,
	...
	public void cacheResult(Slogan slogan) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_COMPANYID,
			new Object[] { new Long(slogan.getCompanyId()) }, slogan);
	}
	...
	public void clearCache(Slogan slogan) {
		...
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_COMPANYID,
			new Object[] { new Long(slogan.getCompanyId()) });
	}
	...
	protected Slogan removeImpl(Slogan slogan) throws SystemException {
		...
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_COMPANYID,
			new Object[] { new Long(sloganModelImpl.getCompanyId()) });
	...
	public Slogan updateImpl(com.inkwell.internet.slogan.model.Slogan slogan,
		...
		if (!isNew &&
				(slogan.getCompanyId() != sloganModelImpl.getOriginalCompanyId())) {
			FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_COMPANYID,
				new Object[] { new Long(sloganModelImpl.getOriginalCompanyId()) });
		}
	...
	/**
	 * Finds the slogan where companyId = &#63; or throws a {@link com.inkwell.internet.slogan.NoSuchSloganException} if it could not be found.
	 *
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Slogan findByCompanyId(long companyId)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchByCompanyId(companyId);
	...
	/**
	 * Finds the slogan where companyId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param companyId the company id to search with
	 * @return the matching slogan, or <code>null</code> if a matching slogan could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public Slogan fetchByCompanyId(long companyId) throws SystemException {
		return fetchByCompanyId(companyId, true);
	}

	/**
	 * Finds the slogan where companyId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param companyId the company id to search with
	 * @return the matching slogan, or <code>null</code> if a matching slogan could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public Slogan fetchByCompanyId(long companyId, boolean retrieveFromCache)
		throws SystemException {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((slogan.getCompanyId() != companyId)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_COMPANYID,
							finderArgs, slogan);
					}
				}
	...
	/**
	 * Removes the slogan where companyId = &#63; from the database.
	 *
	 * @param companyId the company id to search with
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = findByCompanyId(companyId);
